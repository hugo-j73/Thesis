...
nc_files <- list.files(path = "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Thermal comfort and residential appeal/2m temperature", 
...
read_one <- function(nc_path){
  ...
  # 3) read the cube v10[time,lat,lon] 
  arr_u10 <- ncvar_get(nc, "t2m")     # dimensions: (365, 5, 7)
...
#— write the result
write.csv(all_dat,
          "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Thermal comfort and residential appeal/2m temperature/combined_t2m_number.csv",
          row.names = FALSE)
