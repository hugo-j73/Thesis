...
nc_files <- list.files(path = "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Convection and violent storms", 
...
read_one <- function(nc_path){
  ...
  arr_sst <- ncvar_get(nc, "cape")     # dimensions: (365, 5, 7)
...
#— write the result
write.csv(all_dat,
          "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Convection and violent storms/combined_cape_number.csv",
          row.names = FALSE)
