...
nc_files <- list.files(path = "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Coastal risk_flooding/Sea surface temperature", 
...
read_one <- function(nc_path){
  ...
  # 3) read the cube sst[time,lat,lon] 
  arr_sst <- ncvar_get(nc, "sst")     # dimensions: (365, 5, 7)
  
  # 4) rearange to get [lon, lat, time] on our future csv
  arr2 <- aperm(arr_sst, c(3, 2, 1))   # dims: (7, 5, 365)
...
#— write the result
write.csv(all_dat,
          "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Coastal risk_flooding/Sea surface temperature/combined_sst_number.csv",
          row.names = FALSE)

message("✅ Gata well exported in CSV ")
