...
nc_files <- list.files(path = "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Extreme events (wind & storm)/10m u-component of wind", 
...
read_one <- function(nc_path){
  ...
  # 3) read the cube u10[time,lat,lon] 
  arr_u10 <- ncvar_get(nc, "u10")     # dimensions: (365, 5, 7)
...
#— write the result
write.csv(all_dat,
          "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Extreme events (wind & storm)/10m u-component of wind/combined_u10_number.csv",
          row.names = FALSE)
