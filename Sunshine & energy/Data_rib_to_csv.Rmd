...
nc_files <- list.files(path = "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Sunshine & energy", 
...
read_one <- function(nc_path){
  ...
  # 3) read the cube avg_sdirswrf[time,lat,lon] 
  arr_sst <- ncvar_get(nc, "avg_sdirswrf")     # dimensions: (365, 5, 7)
...
#— write the result
write.csv(all_dat,
          "C:/Users/hugoj/Desktop/ESSCA/6. Mémoire/1. redaction/3. Livrable 3/Database/Climate data/V2. Daily/Sunshine & energy/combined_avg_number.csv",
          row.names = FALSE)
